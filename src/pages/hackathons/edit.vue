				...
				<div class="container-lg">
					<div class="row">
						<div id="aside" class="col-md-3 text-center">
							<figure><img src="http://via.placeholder.com/230x230" alt="" class="" @click="upload()"></figure>
						...
						<div id="content" class="col-md-9">
								...
								<ul id="event-data">
									...
									<li><span class="icon-time"></span><input type="text" class="form-control" :value="hack.info.date"></li>
									<li><span class="icon-location"></span><input type="text" class="form-control" :value="hack.info.address"></li>
									<li><span class="icon-clip"><input type="text" class="form-control" :value="hack.info.linkreserv"></span></li>
								</ul>
